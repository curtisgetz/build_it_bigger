...
public class JokeBook {
    ...
    private void initializeJokeList(){
        ...
        mJokes.add("It’s kind of a weird feeling watching the Flintstones lately, with their stone age drive in movies, " +
                "and their caveman bowling.\n\nIt just seems so dated.");
        mJokes.add("I had an uncle, mean guy. He was a prize fighter. He once broke both his hands in a " +
